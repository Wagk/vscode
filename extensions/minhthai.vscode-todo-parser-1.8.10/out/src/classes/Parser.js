...
var Parser = (function () {
    ...
    Parser.parseSingleFile = function (file) {
        ...
        var blocks = [[file.getFile().getText(), 0]]; // an item = [text, line number]
        if (!blocks[0])
            return todos;
        ...
        for (var _c = 0, blocks_2 = blocks; _c < blocks_2.length; _c++) {
            ...
            var item = new all_1.TodoType(file, todo[0], todo[1]);
            todos.push(item);
        }
        return todos;
    };
    ...
    Parser.refine = function (str) {
        ...
        for (var _i = 0, lines_1 = lines; _i < lines_1.length; _i++) {
            ...
            if (flag || all_2.startsWithOne(ln, markers)) {
