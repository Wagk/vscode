...
function testHaveCommand(program, args = ['--version']) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.testHaveCommand = testHaveCommand;
// Given a list of CMake generators, returns the first one available on this
// system
function pickGenerator(candidates) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const gen of candidates) {
            const delegate = {
                Ninja: () => __awaiter(this, void 0, void 0, function* () {
                    return (yield testHaveCommand('ninja-build')) ||
                        (yield testHaveCommand('ninja'));
                }),
                'MinGW Makefiles': () => __awaiter(this, void 0, void 0, function* () {
                    return process.platform === 'win32' && (yield testHaveCommand('make'));
                }),
                'NMake Makefiles': () => __awaiter(this, void 0, void 0, function* () {
                    return process.platform === 'win32' &&
                        (yield testHaveCommand('nmake', ['/?']));
                }),
...
exports.pickGenerator = pickGenerator;
