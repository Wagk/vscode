...
class BlameAnnotationProvider extends vscode_1.Disposable {
    constructor(context, git, whitespaceController, editor, uri) {
        ...
        this._config = vscode_1.workspace.getConfiguration(constants_1.ExtensionKey).get('blame');
        const subscriptions = [];
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.editor) {
                try {
                    ...
                    if (blameAnnotationController_1.BlameDecorations.highlight !== undefined) {
                        setTimeout(() => {
                            if (blameAnnotationController_1.BlameDecorations.highlight === undefined)
                                return;
    ...
    _getCompactGutterDecorations(blame) {
        ...
        return blame.lines.map(l => {
            ...
            if (commit === undefined)
                throw new Error(`Cannot find sha ${l.sha}`);
            let color;
