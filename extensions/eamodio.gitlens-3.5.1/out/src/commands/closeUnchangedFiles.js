                ...
                do {
                    if (editor !== undefined) {
                        if ((editor.document !== undefined && editor.document.isDirty) ||
                            args.uris.some(_ => comparers_1.UriComparer.equals(_, editor.document && editor.document.uri))) {
                            if (active === undefined) {
                                active = editor;
                            }
